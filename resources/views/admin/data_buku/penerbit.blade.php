                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="btn-group" role="group"
                                            ...
                                            <input type="radio" class="btn-check" value="verified"
                                                @if ($penerbit->verif == 'verified') checked
                                            @else
                                                null @endif
                                                name="verif" id="verified{{ $penerbit->id }}" autocomplete="off">
                                            <label class="btn btn-outline-success"
                                                for="verified{{ $penerbit->id }}">Verified</label>

                                            <input type="radio" class="btn-check" value="unverified" name="verif"
                                                id="unverified{{ $penerbit->id }}" autocomplete="off"
                                                @if ($penerbit->verif == 'unverified') checked
                                                @else
                                                    null @endif>
                                            <label class="btn btn-outline-warning"
                                                for="unverified{{ $penerbit->id }}">Unverified</label>
                                        </div>
                                    </div>
