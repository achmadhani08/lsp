            ...
            <table class="table align-middle" id="table1">
                ...
                <tbody>
                    @foreach ($bukus as $buku)
                        <tr>
                            <td class="text-center" style="min-width: 150px">{{ $buku->judul }}</td>
                            <td class="text-center" style="min-width: 100px">{{ $buku->kategori->nama }}</td>
                            <td class="text-center" style="min-width: 100px">{{ $buku->penerbit->nama }}</td>
                            <td class="text-center" style="min-width: 110px">{{ $buku->tahun_terbit }}</td>
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <div class="d-flex mb-3 gap-3 justify-content-center">
                                    <div>
                                        <select name="kategori_id" id="kategori_id" required style="min-width: 200px"
                                    ...
                                    <div>
                                        <select name="penerbit_id" id="penerbit_id" required style="min-width: 200px"
                                            class="form-select choices">
                                ...
                                <div class="d-flex mb-3 gap-3 justify-content-center">
                                    <div>
                                        <input type="number" min="0" max="5000" style="width: 200px"
                                            placeholder="Tahun Terbit" name="tahun_terbit" value=""
                                            class="form-control" required>
                                    </div>
                                    <div>
                                        <input type="number" name="isbn" style="width: 200px" placeholder="ISBN"
                                ...
                                <div class="d-flex mb-3 gap-3 justify-content-center">
                                    ...
                                    <div>
                                        <input type="number" name="j_buku_buruk" style="width: 200px"
                            ...
                            <div class="modal-body">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 gap-3 justify-content-center">
                                        ...
                                        <div>
                                            <input type="number" name="isbn" placeholder="ISBN" style="width: 200px"
