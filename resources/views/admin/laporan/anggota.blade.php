                ...
                <div class="modal-content">
                    <form action="{{ route('admin.anggota_pdf') }}" class="form-group" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="mb-3">
                                    <select name="user_id" required class="choices form-select">
                    ...
                    <form action="{{ route('admin.anggota_excel') }}" class="form-group" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" value="" name="done"
                                            id="btnradio5" autocomplete="off" checked>
                                        <label class="btn btn-outline-info" for="btnradio5">Semua</label>

                                        <input type="radio" class="btn-check" value="true" name="done"
                                            id="btnradio6" autocomplete="off">
                                        <label class="btn btn-outline-success" for="btnradio6">Sudah Dikembalikan</label>

                                        <input type="radio" class="btn-check" value="false" name="done"
                                            id="btnradio7" autocomplete="off">
                                        <label class="btn btn-outline-warning" for="btnradio7">Belum Dikembalikan</label>
                                    </div>
                                </div>
                            </div>
                        </div>
