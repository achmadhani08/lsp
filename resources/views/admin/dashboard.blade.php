...
@section('content-admin')
    @foreach ($pemberitahuans as $pemberitahuan)
        @if ($pemberitahuans->count() > 3)
            {{ null }}
        @elseif ($pemberitahuan->status == 'aktif')
            <div class="alert alert-primary col-12 d-flex align-items-center justify-content-between"
        ...
        @elseif ($pemberitahuan->status == 'admin')
            <div class="alert alert-info col-12 d-flex align-items-center justify-content-between"
                id="notif/{{ $pemberitahuan->id }}" role="alert">
                {{ $pemberitahuan->isi }}
                <button type="button" class="btn btn-secondary" onclick="hide({{ $pemberitahuan->id }});">
                    <i class="bi bi-x-lg"></i>
    ...
    @endforeach
    @if ($pemberitahuans->count() > 3)
        <div class="alert alert-primary col-12 d-flex align-items-center justify-content-between" id="notif/8"
            role="alert">
    ...
    <div class="d-flex gap-3 justify-content-around">
        ...
        <div class="card">
            ...
            <div class="card-footer d-flex justify-content-center">
                <a href="{{ route('admin.data_anggota') }}" class="btn btn-outline-primary">More Info <i
