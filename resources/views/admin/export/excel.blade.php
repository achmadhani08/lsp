        ...
        <tbody>
            @if (count($datas) < 1)
                <tr>
                    <td></td>
                    <td colspan="8"
                        style="text-align: center; font-weight: 500; border: 3px solid black; font-size: 20px">Data
                        Undefined
                    </td>
                </tr>
            @else
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td style="width: 150px; text-align: center; border: 3px solid black">{{ $data->buku->judul }}
                        </td>
                        ...
                        @endif
                        @if ($data->denda)
                            <td style="width: 100px; text-align: center; border: 3px solid black">{{ $data->denda }}
                            </td>
                        @else
